...
class TestMeshAdapter(unittest.TestCase):
    ...
    def test_mesh_sync_state(self):
        ...
        # 节点1更新状态（显式设置时间戳，避免系统时间影响）
        state_to_sync = {"cursor_position": 42, "last_msg_id": "msg_123", "timestamp": 200}
        self.nodes[0].state = state_to_sync.copy()
